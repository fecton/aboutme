		...
		<>
			...
			<main id="main-content" className="min-h-screen pt-24 pb-12">
				<div className="mx-auto max-w-3xl px-6">
					...
					<article className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-[20px] md:p-12">
						<h1 className="mb-2 text-4xl font-bold tracking-tight text-white">
							Privacy Policy
						</h1>
						<p className="mb-8 text-apple-gray">Last updated: January 19, 2026</p>
						...
						<div className="prose prose-invert prose-lg max-w-none">
							...
							<h2 className="mt-10 border-b border-white/10 pb-2 text-2xl font-bold text-white">
								1. Data Controller
							</h2>
							<p>The data controller responsible for your personal data is:</p>
							<div className="my-6 rounded-xl border-l-4 border-accent bg-white/5 p-6">
								<p className="font-semibold text-white">Andrii Lytvynenko</p>
								<p className="text-apple-gray">Czestochowa, Poland</p>
							...
							<ul className="list-disc space-y-2 pl-6 text-apple-gray">
								<li>
							...
							<div className="my-6 rounded-xl border-l-4 border-accent bg-white/5 p-4">
								<strong className="text-white">Data Collected:</strong> Page
							...
							<div className="my-6 overflow-x-auto">
								<table className="w-full border-collapse border border-white/10">
									<thead>
										<tr>
											<th className="border border-white/10 bg-accent/30 px-4 py-3 text-left font-semibold text-white">
												Cookie Type
											</th>
											<th className="border border-white/10 bg-accent/30 px-4 py-3 text-left font-semibold text-white">
												Purpose
									...
									<tbody>
										<tr>
											<td className="border border-white/10 px-4 py-3 text-apple-gray">
										...
										<tr>
											<td className="border border-white/10 bg-white/5 px-4 py-3 text-apple-gray">
												<strong className="text-white">Analytics (Google)</strong>
											</td>
											<td className="border border-white/10 bg-white/5 px-4 py-3 text-apple-gray">
							...
							<ul className="list-disc space-y-2 pl-6 text-apple-gray">
								<li>
									<strong className="text-white">Legitimate Interest (Art.
								...
								<li>
									<strong className="text-white">Contract Performance (Art.
									6(1)(b) GDPR):</strong> When you contact me regarding potential
									B2B collaboration or services.
								</li>
								<li>
									<strong className="text-white">Consent (Art. 6(1)(a)
							...
							<ul className="list-disc space-y-2 pl-6 text-apple-gray">
								<li>
									<strong className="text-white">Analytics Data:</strong> Up to
								...
								<li>
									<strong className="text-white">Server Logs:</strong> Typically
									90 days
								</li>
							</ul>
							...
							<ul className="list-disc space-y-2 pl-6 text-apple-gray">
								<li>
									<strong className="text-white">Right of Access (Art.
									15):</strong> Request a copy of your personal data
								</li>
								<li>
									<strong className="text-white">Right to Rectification (Art.
									16):</strong> Request correction of inaccurate data
								</li>
								<li>
									<strong className="text-white">Right to Erasure (Art.
									17):</strong> Request deletion of your data (&quot;right to be
									forgotten&quot;)
								</li>
								<li>
									<strong className="text-white">Right to Restrict Processing
									(Art. 18):</strong> Request limitation of data processing
								</li>
								<li>
									<strong className="text-white">Right to Data Portability (Art.
									20):</strong> Receive your data in a structured format
								</li>
								<li>
									<strong className="text-white">Right to Object (Art.
